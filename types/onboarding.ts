...
export interface ChatMessage {
  ...
  metadata?: {
    ...
    cardType?: 'place_confirm' | 'brand_profile' | 'scraping' | 'ai_creating' | 'vibe_select' | 'rewards' | 'brand_description' | 'welcome_post' | 'cover_carousel' | 'mission_board' | 'merchant_dashboard' | 'app_building';
