            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white/[0.05] rounded-xl p-3 text-center">
                  <div className="text-fw-green font-heading font-bold text-xl">80+</div>
                  <div className="text-fw-text-tertiary text-xs mt-1">ธุรกิจท้องถิ่น</div>
                </div>
                <div className="bg-white/[0.05] rounded-xl p-3 text-center">
                  <div className="text-fw-green font-heading font-bold text-xl">+107%</div>
                  <div className="text-fw-text-tertiary text-xs mt-1">ยอดธุรกรรม</div>
                </div>
                <div className="bg-white/[0.05] rounded-xl p-3 text-center">
                  <div className="text-fw-green font-heading font-bold text-xl">4.8★</div>
            ...
            <div className="relative">
              ...
              <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-fw-blue/30 to-fw-cyan/20 border border-white/[0.08] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-fw-text-secondary text-sm font-heading">
                    TOURISM AUTHORITY OF THAILAND
                  </div>
                  <div className="text-fw-text-tertiary text-xs mt-1">×</div>
                  <div className="text-fw-green text-sm font-heading font-semibold mt-1">
                    FREEDOM WORLD
                  </div>
                </div>
              </div>
          ...
          {[
            ...
            >
              ...
              <div className="border-t border-white/[0.06] pt-4 flex items-center justify-between">
                ...
                <div className="text-fw-green text-xs font-heading font-bold">{t.metric}</div>
              </div>
            </div>
          ))}
        </div>
